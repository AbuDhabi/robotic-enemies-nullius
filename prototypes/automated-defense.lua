...
local vanilla_fluid_turret = data.raw["fluid-turret"]["flamethrower-turret"]

local acid_turret = table.deepcopy(vanilla_fluid_turret)
acid_turret.name = "nullius-acid-turret"
acid_turret.localised_name = { "entity-name.nullius-acid-turret" }
acid_turret.localised_description = { "entity-description.nullius-acid-turret" }
acid_turret.icon = "__base__/graphics/icons/flamethrower-turret.png"
acid_turret.icon_size = 64
acid_turret.minable = { mining_time = 0.5, result = "nullius-acid-turret" }
acid_turret.fast_replaceable_group = "nullius-acid-turret"
acid_turret.hidden = false
acid_turret.hidden_in_factoriopedia = false
acid_turret.resistances = {
  { type = "acid", percent = 100 },
}
acid_turret.attack_parameters.fluids = {
  { type = "nullius-acid-sulfuric" },
}
acid_turret.attack_parameters.ammo_type.action.action_delivery.stream = "nullius-acid-stream"

data:extend({
  acid_turret,
  {
    type = "item",
    name = "nullius-acid-turret",
    localised_name = { "item-name.nullius-acid-turret" },
    localised_description = { "item-description.nullius-acid-turret" },
    icon = "__base__/graphics/icons/flamethrower-turret.png",
    icon_size = 64,
    subgroup = "demolitions",
    order = "nullius-cd",
    place_result = "nullius-acid-turret",
    stack_size = 50,
    hidden = false,
    hidden_in_factoriopedia = false,
  },
  {
    ...
    results = {
      { type = "item", name = "nullius-acid-turret", amount = 1 },
    },
  },
})
